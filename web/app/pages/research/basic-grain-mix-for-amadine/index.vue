...
const description: Ref<string> = ref('Исследование направлено на выявление процентного соотношения, а также видов зерновых компонентов для закрытия базовых потребностей в микроэлементах организма амадин и астрильдов');
...
Выявленная базовая пропорция: просо желтое: 1.5, просо красное: 1, просо черное: 1, просо белое: 0.5, канарееченое семя: 1.25, пайза: 1, могар: 1.25, лён: 0.5, нуг абиссинский: 0.25, смесь семян лесных трав: 1`,
...
- просо красное: 12 ед
- просо черное: 12 ед
- просо белое: неизвестно, поэтому берем 6 ед на первое время
- канареечное семя: 15 ед
- пайза: 12 ед
- могар: 15 ед
- лён: 9 ед
- нуг абиссинский: неизвестно, но в корме Rio его мало, поэтому берем 4.25 ед

Также, добавим смесь семян лесных трав из разных вариантов, доступных на рынке.
::

::card
---
title: Пропорция смеси
---
- просо желтое: 1.5
- просо красное: 1
- просо черное: 1
...
- могар: 1.25
- лён: 0.5
- нуг абиссинский: 0.25
- смесь семян лесных трав: 1
::
...
Полученная смесь получилась вполне разнообразной, теперь будем смотреть насколько хорошо пернатики будут это кушать.
...
const gallery: Ref<string[]> = ref([
	'/upload/research/basic-grain-mix-for-amadine-gallery-1.webp',
	'/upload/research/basic-grain-mix-for-amadine-gallery-2.webp',
	'/upload/research/basic-grain-mix-for-amadine-gallery-3.webp'
])
...
<template>
	...
	>
		<template #body>
			...
			>
				<img :src="item" width="300" height="300" loading="lazy">
			</UCarousel>
		</template>
	</u-slideover>
</template>
